...
export default async function SourceDataPage() {
  ...
  return <div className="admin-stack"><div><div className="eyebrow">Source Data</div><h1>Imports and reconciliation</h1><p className="lede">Inspect preserved external data, review import runs, and resolve conflicts without silently replacing CMS edits.</p></div><div className="admin-stat-grid"><SourceCard href="/admin/source-data/reconciliation" label="Open reconciliation issues" value={openIssues} /><SourceCard href="/admin/source-data/history" label="Recorded import runs" value={importBatches + airtableJobs + instagramJobs} /><SourceCard href="/admin/airtable" label="Airtable import" value={airtableJobs} /><SourceCard href="/admin/source-data/instagram" label="Instagram import" value={instagramJobs} /></div></div>;
}
