...
export default async function EditorialReviewQueuePage() {
  await requireCapability("publish_content");
  ...
  return (
    <div className="admin-stack">
      ...
      </div> : <p className="empty-note">No narrative revisions are waiting for review.</p>}
    </div>
  );
}
